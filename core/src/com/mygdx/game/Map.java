...
//индекс = это строка в текстурах в качестве столбца берем хп стены
        int index;
        int maxHp;
    ...
    public static final int SIZE_X = 32;  //количество клеток grass40
    ...
    public void checkWallAndBulletsCollision(Bullet bullet) {
        ...
        if (cx >= 0 && cy >= 0 && cx < SIZE_X && cy <= SIZE_Y) //если пуля в пределах карты
        {
